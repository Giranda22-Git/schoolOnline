<template>
    <div class="wrapper">
        <div class="front ">
            <modalFileLoad :autorizedData="autorizedData" v-show="isModalVisible" @close="close()" />
            <div class="left-content-wrapper animate__animated animate__bounceInLeft">
                ...
                <div class="video-link">
                    <ul>
                        ...
                        <div class="post-data a" @click="open()" style="cursor: pointer">
                            <span>27 қазан сағат 00:00 дейін <br> ҮЙ ТАПСЫРМАСЫН ЖҮКТЕ</span>
                        </div>
                        <router-link to="/Certificate" style="cursor: pointer" class="post-data a">
...
<script>
import modalFileLoad from '@/components/modalFileLoad.vue'
